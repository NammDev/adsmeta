...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  pathWidth = 2,
  pathOpacity = 0.2,
  accentColor = "#FF00D4", // Default accent color
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
  ...
  return (
    ...
    >
      ...
      {/* Accent path with higher opacity */}
      <path d={pathD} stroke={accentColor} strokeWidth={pathWidth * 0.6} strokeOpacity={0.4} strokeLinecap="round" />
    </svg>
  )
}
