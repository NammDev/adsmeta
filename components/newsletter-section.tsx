              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-md border border-purple-100/50">
                ...
                <div className="space-y-5 relative z-10">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-4 p-4 rounded-lg bg-gradient-to-r from-[#25D366]/10 to-[#25D366]/5 hover:from-[#25D366]/15 hover:to-[#25D366]/10 transition-colors border border-[#25D366]/20 shadow-sm"
                  >
                  ...
                  <Link
                    ...
                    className="flex items-center gap-4 p-4 rounded-lg bg-gradient-to-r from-[#0088cc]/10 to-[#0088cc]/5 hover:from-[#0088cc]/15 hover:to-[#0088cc]/10 transition-colors border border-[#0088cc]/20 shadow-sm"
                  >
                  ...
                  <Link
                    ...
                    className="flex items-center gap-4 p-4 rounded-lg bg-gradient-to-r from-blue-100/50 to-indigo-100/50 hover:from-blue-100 hover:to-indigo-100 transition-colors border border-blue-200/30 shadow-sm"
                  >
              ...
              <div className="flex-1 space-y-4 relative">
                ...
                <div className="flex items-center gap-3 group relative z-10">
                  ...
                  <div>
                    <Link
                      href="mailto:support@easyadspack.com"
                      className="text-gray-800 font-medium group-hover:text-blue-500 transition-colors"
                    >
                      Email Support
                    </Link>
                    <p className="text-sm text-gray-600">Response within 24 hours</p>
