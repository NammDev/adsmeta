...
import { Check, ArrowRight, ShoppingCart, ChevronLeft, ChevronRight, Crown } from "lucide-react"
...
export default function PackagesSection() {
  ...
  // Initialize currentSlide to 1 (Premium pack) for mobile
  useEffect(() => {
    if (isMobile) {
      setCurrentSlide(1) // Start with Premium pack (index 1)
    }
  }, [isMobile])
      ...
      <div className="container mx-auto px-4 relative">
        ...
        {isMobile && (
          <div className="relative max-w-xs mx-auto">
                    ...
                    <div key={pkg.id} className="w-full flex-shrink-0 px-2">
                      <div className="relative">
                        ...
                        >
                          ...
                          {/* Features */}
                          <CardContent
                            className={`${isPremium ? "p-5 pt-0" : "p-4 pt-0"} relative z-10`}
                          >
            ...
            {/* Carousel Controls */}
            {/* <Button
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white rounded-full shadow-md border-0 z-10 w-8 h-8 p-0"
              onClick={prevSlide}
            ...
            <Button
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white rounded-full shadow-md border-0 z-10 w-8 h-8 p-0"
              onClick={nextSlide}
