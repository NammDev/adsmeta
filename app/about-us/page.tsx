              ...
              >
                ...
                <div className="flex items-start space-x-4 mb-6 relative z-10">
                  ...
                  <div className="relative h-20 w-20 rounded-full overflow-hidden border-3 border-white shadow-lg flex-shrink-0">
                    <div className={`absolute inset-0 bg-gradient-to-r ${member.gradient} p-0.5 rounded-full`}>
                ...
                <div className="flex space-x-3 relative z-10">
                  {/* LinkedIn */}
                  <button className="bg-gray-100 hover:bg-blue-50 text-gray-600 hover:text-blue-600 p-3 rounded-lg transition-all duration-200 group">
                  ...
                  {/* Telegram */}
                  <button className="bg-gray-100 hover:bg-blue-50 text-gray-600 hover:text-blue-500 p-3 rounded-lg transition-all duration-200 group">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
