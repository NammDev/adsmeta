    ...
    <div className="bg-gradient-to-b from-blue-50 via-white to-purple-50">
      ...
      >
        ...
        <div className="container mx-auto px-4 pb-10 md:pb-16 relative z-10">
              ...
              <Card className="overflow-hidden border-0 shadow-xl relative bg-white/80 backdrop-blur-sm mt-8">
                ...
                <CardContent className="p-6 relative z-10">
                  ...
                  <div className="mt-8 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-100 relative overflow-hidden">
                    ...
                    <h4 className="text-lg font-bold mb-3 text-center relative z-10">Still Have Questions?</h4>
          ...
          <div className="mt-16 mb-20 relative overflow-hidden">
            {/* Background Elements for Related Products */}
            <div className="absolute top-0 left-1/4 w-64 h-64 rounded-full bg-blue-200 opacity-10 blur-3xl"></div>
            <div className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full bg-purple-200 opacity-10 blur-3xl"></div>
