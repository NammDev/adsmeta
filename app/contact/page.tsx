...
import { Mail, Phone, Send, MessageCircle, Clock, ExternalLink, CheckCircle, HelpCircle } from "lucide-react"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-white to-green-50 rounded-xl shadow-lg overflow-hidden border border-green-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
              ...
              <div className="p-6 flex items-center relative">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold mb-1 text-green-800 group-hover:text-green-700">WhatsApp Support</h3>
                  <p className="text-green-700 font-medium mb-4">+84 123 456 789</p>
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-lg overflow-hidden border border-blue-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
              ...
              <div className="p-6 flex items-center relative">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold mb-1 text-blue-800 group-hover:text-blue-700">Telegram Channel</h3>
                  <p className="text-blue-700 font-medium mb-4">@EasyAdsPack</p>
                  <div className="flex space-x-3">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-5 group">
                ...
                <div>
                  ...
                  <p className="text-purple-800 font-medium">support@easyadspack.com</p>
            ...
            <div className="bg-gradient-to-br from-white to-purple-50 p-6 rounded-xl shadow-lg border border-purple-100/50 relative overflow-hidden group hover:shadow-xl transition-all">
              ...
              <p className="text-indigo-700 mb-6">Scan these QR codes with your phone to connect with us directly</p>
            ...
            {[
              ...
              >
                <div className="p-6 flex">
                  ...
                  <div>
                    <h3 className={`font-bold text-lg ${faq.textColor} mb-2 group-hover:underline`}>{faq.question}</h3>
