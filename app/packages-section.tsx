...
export default function PackagesSection() {
  ...
  return (
    <section id="packages" className="py-16 md:py-24 relative overflow-hidden">
                ...
                >
                  ...
                  <CardContent className="p-6 pt-0">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Link href={`/packs/${pkg.name.toLowerCase().replace(" ", "-")}`} className="flex-1">
                        <Button
                ...
                {packages.map((pkg, index) => (
                  <div key={pkg.id} className="w-full flex-shrink-0 px-2">
                    <div className="relative">
                      ...
                      <Card
                        className={`border ${pkg.borderColor} rounded-xl overflow-hidden bg-white/90 backdrop-blur-sm shadow-md h-full ${pkg.popular ? "mt-4" : ""}`}
                      >
                        <div className="p-6 pb-0">
                          <div className="flex justify-between items-start mb-4">
                            <div>
              ...
              {packages.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all ${
                    index === currentSlide ? "bg-gradient-to-r from-blue-500 to-purple-500 w-6" : "bg-gray-300"
                  }`}
      ...
      {isMobile && <CartNotification show={showNotification} item={addedItem} onClose={handleCloseNotification} />}
    </section>
  )
}
