    ...
    <PageSection className='py-12'>
      <div className='max-w-4xl mx-auto'>
        <div className={textSpacing.section}>
          ...
          <Lead>
            This page demonstrates the responsive typography system implemented across the site.
          ...
          <div className={textSpacing.section}>
            ...
            <div className='space-y-4'>
              ...
              <div className='p-4 border border-gray-200 rounded-md'>
                <Body>
                  Body Text (fluid-body) - This is the standard paragraph text used throughout the
                  site. It's designed to be readable on all devices with an optimal line length and
                  height.
                </Body>
              ...
              <div className='p-4 border border-gray-200 rounded-md'>
                <Small>
                  Small Text (fluid-body-sm) - Used for less important information, captions, and
                  footnotes.
                </Small>
              ...
              <div className='p-4 border border-gray-200 rounded-md'>
                <Muted>
                  Muted Text - Used for secondary information that shouldn't draw attention away
          ...
          <div className={textSpacing.section}>
            ...
            <div className='space-y-4'>
              <div className='p-4 border border-gray-200 rounded-md'>
                <Body>
                  You can use <InlineCode>InlineCode</InlineCode> for technical terms or code
                  snippets within text.
                </Body>
              </div>
            </div>
          </div>
          ...
          <div className={textSpacing.section}>
            ...
            <ul className='list-disc pl-6 mt-2 space-y-2'>
              ...
              <li>
                <Body>
                  Apply the classes directly:{' '}
                  <InlineCode>{`className="text-fluid-h1 font-bold"`}</InlineCode>
                </Body>
              </li>
            </ul>
          </div>
