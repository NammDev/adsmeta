...
import { ShoppingCart, Shield, CreditCard, Star, Package2, Zap, Clock, Users } from "lucide-react"
...
const sampleProduct = {
  ...
  slug: "verified-bm",
  name: "Verified BM",
  description: "Verified Business Manager with 1 ad account and growing spend limit – ready for immediate use.",
  overview: [
  ...
  imageDescription: "/placeholder.svg?height=400&width=400&query=facebook%20business%20manager",
  reviewComment: "This verified BM saved us so much time. We were able to start running ads within hours of purchase.",
  reviewAuthor: "David Miller",
  reviewAuthorTitle: "Digital Marketing Specialist",
  price: 70,
  comparePrice: 100,
  category: "verified-bm",
  image: "/placeholder.svg?height=200&width=200&query=facebook%20business%20manager%20icon",
  stock: "in-stock",
  badge: "Popular",
}
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-1/4 flex-shrink-0">
                  <div className="relative aspect-square rounded-xl overflow-hidden border-0 bg-white shadow-lg hover:shadow-xl transition-all duration-300 group">
                    ...
                    <Image
                      src={product.imageDescription || product.image}
                      alt={product.name}
                      fill
                ...
                <div className="md:w-3/4 space-y-4">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white flex items-center gap-2 shadow-md hover:shadow-xl transition-all duration-300 py-3 px-6"
                  ...
                  <div className="flex items-center gap-2 mb-0">
                    ...
                    <a href="#reviews" className="text-sm text-gray-500 hover:text-blue-600 transition-colors">
                      120 reviews
                    </a>
                  </div>
                </div>
            ...
            <CardContent className="p-6 relative z-10">
              ...
              <div className="flex items-center justify-center">
                <div className="w-10 h-10 rounded-full bg-white overflow-hidden mr-3 border border-gray-200">
                  <Image
                    src="/placeholder.svg?height=40&width=40&query=profile"
                    alt="Customer"
                    width={40}
                    height={40}
